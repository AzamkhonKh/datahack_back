...
@road-override-fill: #b6b6b6;


@tertiary-fill: @road-override-fill;
@residential-fill: @road-override-fill;
@service-fill: @road-override-fill;
@living-street-fill: @road-override-fill;
@pedestrian-fill: @road-override-fill;
@raceway-fill: @road-override-fill;
@road-fill: @road-override-fill;
@footway-fill: @road-override-fill;
@footway-fill-noaccess: @road-override-fill;
@steps-fill: @road-override-fill;
@steps-fill-noaccess: @road-override-fill;
@cycleway-fill: @road-override-fill;
@cycleway-fill-noaccess: @road-override-fill;
@bridleway-fill: @road-override-fill;
@bridleway-fill-noaccess: @road-override-fill;
@track-fill: @road-override-fill;
@track-fill-noaccess: @road-override-fill;
@platform-fill: @road-override-fill;
@aeroway-fill: @road-override-fill;
@runway-fill: @road-override-fill;
@taxiway-fill: @road-override-fill;
@helipad-fill: @road-override-fill;
